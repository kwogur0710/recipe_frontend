    ...
    const RecipeData = [
        {
            ...
            recipeDetail:
                '1. 소주를 희석시킨물에 소사골을 담궈놓습니다. 2. 사태도 적당한 크기로 잘라 물에 담궈 핏물을 뺍니다. 3. 사골을 넣고 한소끔 끓입니다. 4. 한소끔 끓인 사골은 찬물에 헹궈 놓습니다. 5. 냄비에 쌀뜨물을 붓고 끓입니다. 6. 다시망 두개를 만듭니다. 7. 물이 끓으면 다시망을 넣고 사골을 넣어 푹 고아냅니다. 8. 사태도 기호에 맞게 삶아 냅니다. 9. 삶아낸 사태는 식이후 썰어줍니다. 10. 뚝배기에 불린당면 육수 사태를 넣고 끓입니다. 11. 파를 넣고 식탁에 냅니다.',
        },
        {
            id: '1002',
            type: '한식',
        ...
        },
        {
            ...
            recipeDetail:
                '1. 돼지고기 앞다리살은 키친타월에 올려 핏물제거해 준비합니다. 2. 대파 줄기 부분은 곱게 다져주었어요. 3. 다진 마늘 다진 생강 약간을 준비해요. 4. 핏물 뺀 돼지고기는 볼에 담아 분량의 양념을 넣어주세요. 5. 단음식을 좋아하지 않아 보통 단맛으로 했어요 단맛은 가감하세요. 6. 조물조물 버무려 맛있는 양념이 배이도록 10분간 재웁니다.(양념 : 진간장, 설탕, 맛술, 청주, 참기름, 후춧가루) 7. 팬은 센불에서 뜨겁게 달군 다음 양념한 고기를 넣어 주세요 (센불). 8. 센불로 유지하고 볶아 주는데요 한 번 볶고 잠시 두었다 볶고를 반복해줍니다. 9. 깻잎은 돌돌말아 채썰어 올려주면 바싹 돼지불고기 완성.',
        },
        {
            id: '1009',
            type: '한식',
            ...
            recipeDetail:
                '1. 양파는 얇게썰어 물에담가(30분정도) 매운기를 빼고 준비해 둡니다. 2. 부추는 3-4등분 하여 주세요. 3. 간장,고추가루,식초,설탕,마늘,들기름을 잘 섞어 양념장을 만들어줍니다. 4. 부추, 양파에 양념장을 잘 무쳐주어 깨를 뿌리면 완성.',
        },
        {
            id: '1010',
            type: '한식',
            ...
            recipeDetail:
                '1. 참치캔은 기름기를 제거하고 준비합니다. 2. 볼에 참치 넣고 마요네즈 5, 소금 두꼬집, 후춧가루 조금 뿌려 버무려 줍니다. 3. 밥은 넉넉히 준비한다음 맛소금과 참기름, 통깨 넣고 섞어서 밥을 준비합니다. 4. 비닐봉지 안에 김가루 넣어준다음 밥 떠서 그 안에 참치 마요 한큰술 정도 넣어 동그랗게 주먹밥을 만들어 줍니다. 5. 안 부서지게 단단하게 말아주면 됩니다. 6. 김가루 안에 넣어 굴려주면 주먹밥 완성입니다.',
        },
        {
            id: '2001',
            type: '일식',
