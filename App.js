        ...
        <View style={styles.container}>
            ...
            <View style={styles.recipeTypeFrame}>
                ...
                <View style={styles.recipeTypeButtonwidthFrame}>
                    <View style={styles.recipeTypeButtonFrame}>
                        <View style={styles.recipeTypeButtonImage}><Text style={{fontSize:20}}>사진</Text></View>
                        <View style={styles.recipeTypeButtonText}><Text style={{fontSize:20}}>한식</Text></View>
                    </View>
                    <View style={styles.recipeTypeButtonFrame}>
                        <View style={styles.recipeTypeButtonImage}><Text style={{fontSize:20}}>사진</Text></View>
                        <View style={styles.recipeTypeButtonText}><Text style={{fontSize:20}}>일식</Text></View>
                    </View>
                    <View style={styles.recipeTypeButtonFrame}>
                        <View style={styles.recipeTypeButtonImage}><Text style={{fontSize:20}}>사진</Text></View>
                        <View style={styles.recipeTypeButtonText}><Text style={{fontSize:20}}>중식</Text></View>
                    </View>
                    <View style={styles.recipeTypeButtonFrame}>
            ...
            <View style={styles.recipeVideoFrame}>
                ...
                <View style={styles.recipeVideoYoutubeFrame}>
                    ...
                    <View style={styles.recipeVideoYoutube}><Text style={{fontSize:20}}>유튜브 영상</Text></View>
                    <View style={styles.recipeVideoYoutubeBlank}></View>
                    <View style={styles.recipeVideoYoutube}></View>
                </View>
            </View>
